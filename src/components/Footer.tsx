        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-1 mb-4">
              ...
              <span className="text-ink font-semibold text-lg">ESCORTS</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="/micuenta/resumen" className="text-muted hover:text-ink text-sm transition-colors">Panel Escort</a></li>
              <li><a href="/unirse" className="text-muted hover:text-ink text-sm transition-colors">Registro Usuario</a></li>
              <li><a href="/micuenta/registro" className="text-muted hover:text-ink text-sm transition-colors">Registro Escort</a></li>
              <li><a href="/ingresar" className="text-muted hover:text-ink text-sm transition-colors">Entrar como Usuario</a></li>
              <li><a href="/micuenta/login" className="text-muted hover:text-ink text-sm transition-colors">Entrar como Escort</a></li>
            </ul>
          </div>

          <div>
            <h3 className="text-red-400 font-semibold text-sm uppercase tracking-wider mb-4">Contacto</h3>
            <a href={`mailto:contacto@${siteName.toLowerCase()}.cl`} className="flex items-center gap-2 text-muted hover:text-ink text-sm transition-colors">
