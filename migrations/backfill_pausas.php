<?php
// migraciones/backfill_pausas.php
...
//   php migraciones/backfill_pausas.php
// (o por servidor web si hay CLI disponible en el hosting).

// Localizar bootstrap.php (puede ejecutarse desde la raíz del repo o subido al servidor).
$bootstrapCandidates = array(
    __DIR__ . '/../public/api/bootstrap.php',
    __DIR__ . '/public/api/bootstrap.php',
    __DIR__ . '/api/bootstrap.php',
    getcwd() . '/public/api/bootstrap.php',
